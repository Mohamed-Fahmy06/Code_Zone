    ...
    <div className="bg-surface selection:bg-secondary/30 min-h-screen">
      ...
      <main className="pt-32 pb-24 px-lg max-w-container-max mx-auto">
        ...
        <section className="mb-20 text-center md:text-right relative">
          ...
          <h1 className="font-display-lg text-display-lg md:text-[64px] mb-4 cyber-gradient-text leading-tight">تواصل معنا</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="font-code-label text-code-label text-secondary uppercase block">الاسم الكامل</label>
                  <input className="glow-input w-full bg-surface-container-low border border-white/10 focus:ring-0 rounded-xl p-4 text-on-surface outline-none transition-all text-right" placeholder="أحمد محمد" type="text" required />
                </div>
                <div className="space-y-2">
                  <label className="font-code-label text-code-label text-secondary uppercase block">البريد الإلكتروني</label>
                  <input className="glow-input w-full bg-surface-container-low border border-white/10 focus:ring-0 rounded-xl p-4 text-on-surface outline-none transition-all text-left" dir="ltr" placeholder="email@example.com" type="email" required />
                </div>
              </div>
              <div className="space-y-2">
                <label className="font-code-label text-code-label text-secondary uppercase block">نوع المشروع</label>
                <select className="glow-input w-full bg-surface-container-low border border-white/10 focus:ring-0 rounded-xl p-4 text-on-surface outline-none transition-all appearance-none cursor-pointer text-right">
              ...
              <div className="space-y-2">
                <label className="font-code-label text-code-label text-secondary uppercase block">رسالتك</label>
                <textarea className="glow-input w-full bg-surface-container-low border border-white/10 focus:ring-0 rounded-xl p-4 text-on-surface outline-none transition-all text-right" placeholder="أخبرنا المزيد عن رؤيتك..." rows="5" required></textarea>
              </div>
              <button 
                className={`primary-btn-gradient w-full md:w-auto text-white font-title-md px-12 py-4 rounded-xl active:scale-95 transition-all shadow-lg shadow-primary/10 ${status === 'sending' ? 'opacity-70 cursor-not-allowed' : ''}`}
                type="submit"
          ...
          <div className="lg:col-span-5 flex flex-col gap-lg text-right">
            {/* Details Card */}
            <div className="glass-panel rounded-2xl p-lg relative overflow-hidden border border-white/5">
              <h3 className="font-headline-lg text-headline-lg text-on-surface mb-8">معلومات التواصل</h3>
              <div className="space-y-8">
                <div className="flex flex-row-reverse items-center gap-4 group">
                  ...
                  <div>
                    <p className="font-code-label text-code-label text-secondary">الهاتف</p>
                    <p className="font-title-md text-title-md text-on-surface" dir="ltr">+966 50 123 4567</p>
                  </div>
                </div>
                <div className="flex flex-row-reverse items-center gap-4 group">
                  ...
                  <div>
                    <p className="font-code-label text-code-label text-secondary">البريد الإلكتروني</p>
                    <p className="font-title-md text-title-md text-on-surface" dir="ltr">hello@codezone.sa</p>
                  </div>
                </div>
                <div className="flex flex-row-reverse items-center gap-4 group">
                  <div className="w-14 h-14 rounded-xl bg-tertiary/10 flex items-center justify-center text-tertiary group-hover:bg-tertiary/20 transition-colors">
                    <span className="material-symbols-outlined text-2xl">location_on</span>
                  </div>
                  <div>
                    <p className="font-code-label text-code-label text-secondary">الموقع</p>
                    <p className="font-title-md text-title-md text-on-surface">الرياض، مجمع الابتكار التقني</p>
                  </div>
                </div>
              </div>
              <div className="mt-10 pt-8 border-t border-white/10">
                <p className="font-code-label text-code-label text-on-surface-variant mb-4">تابعنا على</p>
                <div className="flex flex-row-reverse gap-4">
                  <a className="w-12 h-12 rounded-xl glass-panel flex items-center justify-center text-secondary hover:text-primary transition-all duration-300 border border-white/5" href="#">
        ...
        <div className="mt-20 glass-panel rounded-2xl overflow-hidden border border-white/10">
          ...
          <div className="p-6 font-code-label text-body-sm space-y-2 opacity-80" dir="ltr">
