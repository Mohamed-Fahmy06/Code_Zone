...
export default function Header() {
  ...
  return (
    <nav className="fixed top-0 w-full z-50 bg-surface/60 backdrop-blur-xl border-b border-white/10 shadow-[0_0_20px_rgba(98,0,238,0.15)] h-20">
      <div className="flex flex-row-reverse justify-between items-center max-w-container-max mx-auto px-lg h-full">
        <div className="flex items-center gap-md">
          ...
          <span className="font-headline-lg text-headline-lg font-black tracking-tighter text-primary">كود زون</span>
        </div>
        <div className="hidden md:flex flex-row-reverse items-center gap-xl">
          <Link 
        ...
        <Link to="/contact" className="primary-btn-gradient px-lg py-sm rounded-lg font-title-md text-white active:scale-95 duration-200">
          ابدأ مشروعك
        </Link>
      </div>
    </nav>
